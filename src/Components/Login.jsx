...
export const Advertise=()=>{
    return (
        <div className="z-10 lg:flex flex-col justify-around items-center hidden w-5/12 shadow-lg shadow-neutral-800 rounded-tr-lg rounded-br-lg h-screen fixed top-0 left-0 bg-neutral-900">
            <Link to="/"><h1 className="text-white font-bold text-5xl 2xl:text-7xl font-title tracking-widest">Yenjah?<span className=" text-blue-500">.tn</span></h1></Link>
...
const LoginForm=()=>{
    ...
    return (
        <form className="ml-auto min-h-screen flex flex-col justify-center 2xl:space-y-20 lg:space-y-10 space-y-14 items-center lg:w-7/12 w-full font-body my-10">
