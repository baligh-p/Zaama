...
export const Advertise=()=>{
    return (
        <div className="z-10 lg:flex flex-col justify-around items-center hidden w-5/12 shadow-lg shadow-neutral-800 rounded-tr-lg rounded-br-lg h-full bg-neutral-900">
...
const LoginForm=()=>{
    ...
    return (
        <form className="flex flex-col justify-center 2xl:space-y-20 lg:space-y-10 space-y-14 items-center lg:w-7/12 w-full font-body my-10">
            ...
            <div className="lg:w-7/12 md:w-8/12 w-10/12 flex items-center space-x-3">
                ...
                <label onClick={()=>{keepMeLoggedInput.current.click()}} className="text-sm text-stone-500 cursor-pointer">Keep me Logged</label>
            </div>
            <button className="border-2 border-blue-600 rounded-sm bg-blue-600 py-2 px-7 text-white text-lg lg:w-7/12 md:w-8/12 w-10/12 hover:bg-white hover:text-blue-600 transition-all duration-200 delay-100">Log in</button>
            <div className="lg:w-7/12 w-full flex justify-center items-center lg:absolute bottom-0 bg-stone-100" >
